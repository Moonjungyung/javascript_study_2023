...
console.log(num1==num3) //true (데이터타입 구분못함)
console.log(num1===num3) //true (데이터타입 구분)
...
//d와 true의 데이터타입까지 같다면 실행이 출력된다 - o
if(f>10){console.log('실행2')}
//f가 10보다 크다면 실행2가 콘솔에 출력된다 - x
if(g<=20){console.log('실행3')}
//g가 20보다 작거나 같다면 실행3가 콘솔에 출력된다 - o
if(e!==true){console.log('실행4')}
//e가 true와 다르다면 실행 4가 콘솔에 출력된다 - o
console.log('-----------------')
//관리자만 접속할 수 있는 페이지

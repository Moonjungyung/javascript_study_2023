...
console.log(++num1);
console.log(num1);
//출력 또는 대입연산자와 함께할 때 전위, 후위 연산자에 따른 결과값이 다르게 출력된다.
//출력예) console.log(num1++)
//콘솔 로그로 기존 num1의 값을 먼저 전송출력 후 ++ 증감연산자로 num1의 값을 나중에 1증가한다.
// 출력, 대입 관계없이 증감연산자를 개별로 작성한 경우 전위, 후위 연산과 관계없이 무조건 1증가 또는 1 감소한다.
let num2 = 5
let num3 = 0
